...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/android.hardware.face.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.face.xml\
...
PRODUCT_PACKAGES += \
    android.hardware.usb@1.1-service.coral
