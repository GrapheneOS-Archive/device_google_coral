...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/init.qcom.usb.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.$(PRODUCT_PLATFORM).usb.rc \
    ...
    $(LOCAL_PATH)/thermal-engine-$(PRODUCT_HARDWARE)-vr.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine-$(PRODUCT_HARDWARE)-vr.conf \
...
PRODUCT_COPY_FILES += \
    ...
    device/google/coral/nfc/libnfc-nci.conf:$(TARGET_COPY_OUT_SYSTEM)/etc/libnfc-nci.conf
...
# Vibrator HAL
PRODUCT_PACKAGES += \
    android.hardware.vibrator@1.2-service.coral \

# Thermal HAL
PRODUCT_PACKAGES += \
    android.hardware.thermal@1.0-service.coral \
...
# VR HAL
PRODUCT_PACKAGES += \
    android.hardware.vr@1.0-service.coral \
